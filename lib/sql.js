...
var username = configs.apiKey;//'gyFG80njksqzyzwyiDxc3Irv';
var password = configs.secretKey;//'do6Blf9QzzYpTBsjKX5K1RNqb5odcefG';
var db_host = 'sqld.duapp.com';
var db_port = 4050;
var db_name = configs.baeMysql;//'fMPIpSPaGoLMDWIvAqGs';
var option = {
  host: db_host,
  port: db_port,
  user: username,
